...
fun main() {
    ...
    val height: Double = readln().trim().toDouble()
    ...
    val resultToPrint = when {
        ...
        imt < IMT_NORMAL_MAX -> "$IMT_NOT_ENOUGH_MAX ≤ ИМТ < $IMT_NORMAL_MAX: Нормальная масса тела"
        imt < IMT_OVER_MAX -> "$IMT_NORMAL_MAX ≤ ИМТ < $IMT_OVER_MAX: Избыточная масса тела"
