...
fun main() {
    ...
    val resultToPrint = when {
        imt < IMT_NOT_ENOUGH_MAX -> "ИМТ < $IMT_NOT_ENOUGH_MAX: Недостаточная масса тела"
        imt in IMT_NOT_ENOUGH_MAX..<IMT_NORMAL_MAX -> "$IMT_NOT_ENOUGH_MAX ≤ ИМТ < $IMT_NORMAL_MAX: Нормальная масса тела"
        imt in IMT_NORMAL_MAX..<IMT_OVER_MAX -> "$IMT_NORMAL_MAX ≤ ИМТ < $IMT_OVER_MAX: Избыточная масса тела"
