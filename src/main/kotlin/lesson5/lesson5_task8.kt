...
цитаты из произведения "Автостопом по галактике" Дугласа Адамса. Программа должна выполнить
HTTP-запрос, получить HTML-контент страницы, найти цитаты и вывести их на экран.
